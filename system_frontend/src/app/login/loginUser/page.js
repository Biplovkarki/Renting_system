...
export default function LoginOwner() {
    return (
        <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100"> {/* Added min-h-screen for full height */}
            ...
            <h1 className="mt-4">Are you a member of Easy Rent Nepal? <Link href="/registerUser" className="text-blue-500 hover:underline">Register here</Link></h1>
            <h1 className="mt-4">Are you a owner ? <Link href="/owner/loginOwner" className="text-blue-500 hover:underline">Owner Login</Link></h1>
            </div>
        </div>
    );
}
